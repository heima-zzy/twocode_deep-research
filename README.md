...
Please refer to the file [env.tpl](./env.local) for all available environment variables.
...
**Note:** To ensure that the MCP service can be used normally, you need to set the environment variables of the corresponding model and search engine. For specific environment variable parameters, please refer to [env.tpl](./env.local).
